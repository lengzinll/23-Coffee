      ...
      <div className="grid gap-6 lg:grid-cols-12">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="p-4 bg-zinc-900/50 border border-zinc-800 flex items-start gap-3 rounded-xl">
            ...
            <div>
              <h4 className=" font-bold text-zinc-200">សុវត្ថិភាពទិន្នន័យ (Data Security)</h4>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4 bg-zinc-900 border border-zinc-800 rounded-xl space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-sm uppercase font-black tracking-tighter text-zinc-400">Scheduler</span>
                <div className="w-1.5 h-1.5 rounded-full bg-green-500" />
              </div>
              <div className="text-zinc-100 font-bold font-mono tracking-tight">Active</div>
            </div>
            <div className="p-4 bg-zinc-900 border border-zinc-800 rounded-xl space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-sm uppercase font-black tracking-tighter text-zinc-400">Reporting</span>
                <div className="w-1.5 h-1.5 rounded-full bg-blue-500" />
              </div>
              <div className="text-zinc-100 font-bold font-mono tracking-tight">Healthy</div>
            </div>
          </div>
